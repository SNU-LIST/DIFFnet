function[S_matrix,gradient_matrix,info_matrix,signal_num_matrix] = simulator_DTI(iter)

%
%  Description:
%  Monte-Carlo diffusion simulation for DTI model
%
...
Gmax = sqrt((1300*1e+6)/(Largedelta-Smalldelta/3))/(gyroratio*Smalldelta);
voxel_length = 2*1e-3;  
proton_num = 1e+6;
